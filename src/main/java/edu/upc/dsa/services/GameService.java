...
public class GameService {
    ...
    public GameService() {
        ...
        if (manager.size() == 0) {
            ...
            this.manager.añadirFAQ("Como hago para logearme","Tienes que introducir tus credenciales");
            this.manager.añadirFAQ("Como hago para deslogearme","Tienes que borrar la caché porque somos muy cutres");
            this.manager.añadirRanking("jose33","25/03/2000",50,"https://www.info-computer.com/156049-medium_default/logitech-lgt-m90-1000-dpi-gris-q.jpg");
            this.manager.añadirRanking("manolo57","22/03/1999",100,"https://img.freepik.com/vector-premium/monitor-computadora-realista_88272-327.jpg");
            this.manager.añadirRanking("cristian22","09/05/2001",30,"https://www.shutterstock.com/image-photo/computer-keyboard-isolated-on-white-260nw-222047851.jpg");
        }
    }
...
/*        Objeto objeto = this.manager.getObjetoPorNombre(idUsuario);
 ...
 /*   @GET
    ...
    public Response getRanking() {
        ...
        List<Ranking> ranking = this.manager.listadeJugadoresOrdenadosPorPuntos();
    ...
    public Response getlistaFAQ() {
        List<FAQ> faqs = this.manager.listadeFAQ();
