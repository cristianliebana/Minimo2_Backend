...
public class GameManagerImpl implements GameManager {
    ...
    HashMap<String, FAQ> FAQs;

    protected List<FAQ> listaFAQ;

    protected List<Ranking> listaRanking;
    ...
    public List<FAQ> listadeFAQ() {
        logger.info("Lista de FAQS: " + listaFAQ.toString());
        return this.listaFAQ;
    }

    @Override
    public List<Ranking> listadeJugadoresOrdenadosPorPuntos() {
        this.listaRanking.sort(new Comparator<Ranking>() {
            public int compare(Ranking o1, Ranking o2) {
                return Double.compare(o2.getPuntos(), o1.getPuntos());
            }
        });
        logger.info("Lista ordenada por puntosascendente: " + listaRanking.toString());
        return listaRanking;
    ...
    public void añadirRanking(String nickname, String fecha, double puntos, String avatar) {
        this.listaRanking.add(new Ranking(nickname,fecha,puntos,avatar));
        logger.info("Se ha añadido correctamente");
    }
    @Override
